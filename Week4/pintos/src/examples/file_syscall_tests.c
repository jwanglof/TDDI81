/* klaar@ida
   ...
   by various IDA-employees / lab-assistanst. Use command line:
   ...
   TODO: Warn when (result == JUNK)
   TODO: Compare/verify content of buffer after reads.
   TODO: Make sure content of buffer is known/reset before filling it.
 */
...
int main(int argc, char* argv[])
{
  ...
  msg ( "* ----------------- read keyboard test ------------------ *" );
  {
    ...
    printf ("Write 10 characters please: ");
    result = read ( STDIN_FILENO, buffer, 10 );
    length = strlen( buffer );
    printf ("\nThe following characters was read: '%s'", buffer);
